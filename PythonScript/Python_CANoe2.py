...
class CANoe:
    ...
    def ReadTestSetup(self):
        ...
        TestEnvs =self.application.Configuration.TestSetup.TestEnvironments
        TestEnv = TestEnvs.Item(1)
        TestEnv = CastTo(TestEnv, "ITestEnvironment2")
        #self.Tester = TestEnv.Items.Item(1)
        print(type(TestEnv.TestModules))
        tt = TestEnv.TestModules.Modules()
        #tt.Enabled = True
        tt.Start()
